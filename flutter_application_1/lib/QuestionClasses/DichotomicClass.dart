...
class DichotomicClass extends Question {
  ...
  DichotomicClass(String txt, int identifiant, List<String> options, List<int> next) {
    text=txt;
    id=identifiant;
    _options=options;
    _next = next;
  ...
  factory DichotomicClass.fromJson(dynamic json) {
    return DichotomicClass(json['text'] as String, json['id'] as int, json['options'] as List<String>, json['next'] as List<int> );
  }
